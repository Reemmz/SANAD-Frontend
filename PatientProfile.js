              ...
              <Block flex style={styles.profileCard}>
                <Block flex>
                  <Block middle style={styles.nameInfo}>
                    ...
                    <Text size={18} color="#32325D" style={{ alignSelf: "center", marginTop: 30, fontWeight:"bold" }}>
                      الاسم:
                    </Text>
                    ...
                    <Text size={18} color="#32325D" style={{ alignSelf: "center", marginTop: 10, fontWeight:"bold" }}>
                      كلمة المرور :
                    </Text>
